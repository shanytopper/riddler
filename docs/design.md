...
8. Editor v0 (D34): the operator edits the track and publishes a new version from a small web console served by the API, with the map for pins, the validation report, and leaderboard moderation.
