...
const STRINGS = {
  en: {
    ...
    restartNote: "Layout direction follows the device language and changes after the app restarts.",
    version: "Version",
  ...
  he: {
    ...
    restartNote: "כיוון הפריסה נקבע לפי שפת המכשיר ומשתנה לאחר הפעלה מחדש של האפליקציה.",
    version: "גרסה",
