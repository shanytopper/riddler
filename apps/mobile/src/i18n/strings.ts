...
const STRINGS = {
  en: {
    ...
    startHere: "Start here: {note}",
    waypointStart: "Start",
    waypointFinish: "Finish",
    waypointStartFinish: "Start & finish",
    youveReached: "You've reached {station}",
    openStation: "Open the station",
    distanceAway: "{distance} away",
    gpsAccuracy: "GPS accuracy ±{n} m",
    locationRationale:
      "Your position is shown on the map and used to confirm you reached a station — only while the app is open.",
    allowLocation: "Allow location",
    notNow: "Not now",
    locationOff: "Location is off for this app",
    openSettings: "Open settings",
    locationOffCheckIn: "Location is off — check in by hand",
    noFixCheckIn: "No GPS fix yet — if you're at the station, check in by hand",
    poorAccuracyCheckIn: "GPS accuracy is ±{n} m — check in by hand when you're there",
    ...
    trailEndsHere: "The trail ends here",
    trailEndsAtStart: "The trail ends where it began",
  ...
  he: {
    ...
    startHere: "מתחילים כאן: {note}",
    waypointStart: "התחלה",
    waypointFinish: "סיום",
    waypointStartFinish: "התחלה וסיום",
    youveReached: "הגעתם אל {station}",
    openStation: "לפתוח את התחנה",
    distanceAway: "במרחק {distance}",
    gpsAccuracy: "דיוק ה-GPS: ±{n} מ׳",
    locationRationale: "המיקום שלכם מוצג במפה ומשמש לאישור ההגעה לתחנה — רק כשהאפליקציה פתוחה.",
    allowLocation: "אישור גישה למיקום",
    notNow: "לא עכשיו",
    locationOff: "הגישה למיקום כבויה לאפליקציה הזו",
    openSettings: "פתיחת ההגדרות",
    locationOffCheckIn: "הגישה למיקום כבויה — אשרו את ההגעה ידנית",
    noFixCheckIn: "עדיין אין קליטת GPS — אם אתם בתחנה, אשרו את ההגעה ידנית",
    poorAccuracyCheckIn: "דיוק ה-GPS הוא ±{n} מ׳ — כשתגיעו, אשרו את ההגעה ידנית",
    ...
    finished: "סיימתם!",
    trailEndsHere: "המסלול מסתיים כאן",
    trailEndsAtStart: "המסלול מסתיים במקום שבו התחיל",
