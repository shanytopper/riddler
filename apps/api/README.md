...
- **The app:** set `EXPO_PUBLIC_API_URL=https://riddles-api-vv2y.onrender.com` in `apps/mobile/.env` and build a release APK; the app reads venues, tracks, and bundles from it and syncs its event log to it.
